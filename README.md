This fork of graphql-query-builder adds the EnumValue type that won't be wrapped in an extra set of double-quotes by the filter builder. Index.js now exports both Query and EnumValue.
